# Contributing to Support Triage Studio

Support Triage Studio is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A support triage studio for clustering fictional tickets, scoring urgency, drafting response paths, and exporting a fix queue.
